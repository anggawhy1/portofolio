...
function About() {
  ...
  return (
    <section
      id="about"
      className={`relative w-full px-4 sm:px-10 lg:px-20 xl:px-32 py-20 overflow-hidden transition-colors duration-300 ${
        isDark
    ...
    >
      ...
      >
        ...
        >
          ...
          {/* Region */}
          <p
            className={`text-sm md:text-base font-medium text-center md:text-left mb-3 ${
